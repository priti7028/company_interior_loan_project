    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Customer', 'Customer'), ('Loan_Representative', 'Loan_Representative'), ('Operational_Head', 'Operational_Head'), ('Loan_Sanction_Officer', 'Loan_Sanction_Officer'), ('Admin', 'Admin')], default='Customer', max_length=50)),
